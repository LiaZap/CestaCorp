...
# do EasyPanel após o deploy). O standalone do Next inclui só o que o bundle precisa em runtime,
# mas tasks administrativas (migrations, seed, retrofill) exigem o conjunto completo.
